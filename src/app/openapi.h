...
namespace app::openapi {
    ...
    DECLARE_JSON_REQUIRED_FIELDS(ResponseHeader, cluster_id, member_id, revision, raft_term, committed_revision, committed_raft_term)
    ...
    DECLARE_JSON_REQUIRED_FIELDS(KeyValue, key, value, create_revision, mod_revision, version)
    ...
    DECLARE_JSON_OPTIONAL_FIELDS(Put::In, lease, prev_kv, ignore_value, ignore_lease)
