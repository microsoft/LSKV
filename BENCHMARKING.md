...
If using a VM scale set in Azure, running the following will get the IP addreses into the hosts file for you:
...
```sh
ansible-playbook -i hosts benchmark/setup_nodes.yaml -e @benchmark/values.yaml
```
