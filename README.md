...
```bash
wget https://github.com/microsoft/CCF/releases/download/ccf-4.0.0-rc0/ccf_virtual_4.0.0_rc0_amd64.deb
sudo dpkg -i ccf_virtual_4.0.0_rc0_amd64.deb # Installs CCF under /opt/ccf_virtual
